...
public class AgregarCantidadException extends RuntimeException{

    private static final Severidad serialVersionUID = SEVERIDAD_MEDIA;

    private static final String ERROR = "Error al agregar la cantidad del producto";

    public AgregarCantidadException(String mensaje, Throwable motivo){
