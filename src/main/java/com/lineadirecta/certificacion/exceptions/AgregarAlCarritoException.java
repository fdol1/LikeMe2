...
public class AgregarAlCarritoException extends RuntimeException{

    private static final Severidad serialVersionUID = SEVERIDAD_MEDIA;

    private static final String ERROR = "Error al agregar al carrito";

    public AgregarAlCarritoException(String mensaje, Throwable motivo){
